...
export default function Cart() {
  ...
  function handleDecreseItem(productId:number) {
    ...
    <main>
      <section id="cart-container-section" className="dsc-container">
                ...
                <div className="dsc-cart-item-left">
                  ...
                  <div className="dsc-cart-item-description">
                    ...
                    <div className="dsc-cart-item-quantity-container">
                      <div onClick={() => handleDecreseItem(item.productId)} className="dsc-cart-item-quantity-btn">-</div>
                      <p>{item.quantity}</p>
        ...
        <div className="dsc-btn-page-container">
          ...
          <div onClick={handleClearClick} className="dsc-btn dsc-btn-white">Limpar  o carrinho</div>
        </div>
      </section>
    </main>
  );
